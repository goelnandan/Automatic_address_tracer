...
def window():
	...
	result1= Label(root, textvariable=var1,font=(7))
	result1.pack()
	gap1 = Label(root, text="              ")
	gap1.pack(fill=X,ipadx=3)
	result2= Label(root, textvariable=var2,font=(7))
	result2.pack()
	gap1 = Label(root, text="              ")
	gap1.pack(fill=X,ipadx=3)
	result3= Label(root, textvariable=var3,font=(7))
	result3.pack()
	gap1 = Label(root, text="              ")
	gap1.pack(fill=X,ipadx=3)
	result4= Label(root, textvariable=var4,font=(7))
	result4.pack()
